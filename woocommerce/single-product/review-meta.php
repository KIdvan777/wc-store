...
<?php } else { ?>
	...
	<p class="meta">
		<div class="woocommerce-review__author"><?php comment_author(); ?> </div>
		<?php
		...
		?>
		<h5><time class="woocommerce-review__published-date" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php echo esc_html( get_comment_date( wc_date_format() ) ); ?></time><h5>
	</p>
