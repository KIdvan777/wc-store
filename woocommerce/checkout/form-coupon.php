...
<form class="checkout_coupon woocommerce-form-coupon row" method="post" style="display:none">
	...
	<p class="col-lg-12"><?php esc_html_e( 'If you have a coupon code, please apply it below.', 'woocommerce' ); ?></p>

	<p class="form-row form-row-first col-lg-6">
	...
	<p class="form-row form-row-last col-lg-6">
		<button type="submit" class="button btn btn-default" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
	</p>
