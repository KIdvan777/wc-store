...
add_filter( 'post_class', 'wc_add_class_loop_item' );
function wc_add_class_loop_item($clasess){
	if(is_shop() || is_product_taxonomy()){
		$clasess[] = 'col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles';
	}
	return $clasess;
}
add_filter( 'post_class', 'wc_add_class_loop_item_cross' );
function wc_add_class_loop_item_cross($clasess){
	if(is_cart()){
