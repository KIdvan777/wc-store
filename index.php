							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="<?= get_template_directory_uri() . '/assets/images/4.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/5.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/6.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/7.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/3.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/4.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/5.jpg'?>" alt=" " class="img-responsive" />
								...
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										...
										<img src="<?= get_template_directory_uri() . '/assets/images/6.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/7.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/8.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/9.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/5.jpg'?>" alt=" " class="img-responsive" />
										<img src="<?= get_template_directory_uri() . '/assets/images/6.jpg'?>" alt=" " class="img-responsive" />
										<div class="w3_hs_bottom">
											<ul>
